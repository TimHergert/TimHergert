...
(function (farmsimulation) {
    ...
    function createPaths() {
        farmsimulation.animalpath = createAsteroidPaths(farmsimulation.animals);
        cowPathPath = createUfoPath();
    }
    farmsimulation.createPaths = createPaths;
    function createAnimalPaths(_shapes) {
        let paths = [];
